# DiGi Moda
![DiGi Moda](/public/thumbnail.png)

  The __all-in-one__ DiGi Moda
  for building multi-tenant application

  ## [Introduction](#introduction)
  ### [Guide](https://vercel.com/guides/nextjs-multi-tenant-application)
  ### [Kitchen Sink](https://steven.digimoda.xyz/kitchen-sink)
  ### [Contributing](#contributing)

## Introduction

The [Platforms Starter Kit](https://app.digimoda.xyz/) is a full-stack Next.js app with multi-tenancy and custom domain support. Built with [Next.js App Router](https://nextjs.org/docs/app), [Vercel Postgres](https://vercel.com/storage/postgres) and the [Vercel Domains API](https://vercel.com/docs/rest-api/endpoints#domains).
...
![prefers-color-scheme: dark](https://images.ctfassets.net/e5382hct74si/k7XpXIE0rDsHCAYvkKhff/ff44c07588068d8fefa334cd6a318c8a/CleanShot_2023-07-05_at_08.39.02.png)

![prefers-color-scheme: light](https://images.ctfassets.net/e5382hct74si/7tiAitb8kdgUGktycr540c/d33f2834f9356bce25e0721c4ebe4f9a/CleanShot_2023-07-05_at_08.39.10.png)
...
- Subdomain: [demo.digimoda.xyz](http://demo.digimoda.xyz)
- Custom domain: [platformize.co](http://platformize.co) (maps to [demo.digimoda.xyz](http://demo.digimoda.xyz))
- Build your own: [app.digimoda.xyz](http://app.digimoda.xyz)
