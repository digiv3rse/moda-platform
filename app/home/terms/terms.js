    ...
    <Container className="text-black dark:text-white">
      <div className="mx-auto w-full max-w-4xl px-4 py-12 md:px-6 md:py-16">
        ...
        <section className="mb-8 md:mb-12">
          ...
          <h2 className="mb-4 text-2xl font-bold md:text-xl">Interpretation</h2>
          <p className="mb-4 text-black dark:text-white">
        ...
        <section className="mb-8 md:mb-12">
          <h2 className="mb-4 text-2xl font-bold md:text-xl">Definitions</h2>
          <p className="mb-4 text-black dark:text-white">
          ...
          <ul>
            <li>
              <p className="mb-4 text-black dark:text-white">
                ...
                downloaded by You on any electronic device, named DiGi Moda
              </p>
            </li>
            <li>
              <p className="mb-4 text-black dark:text-white">
        ...
        <section className="mb-8 md:mb-12">
          ...
          <h2 className="mb-4 text-2xl font-bold md:text-3xl">Termination</h2>
          <p className="mb-4 text-black dark:text-white">
        ...
        <section className="mb-8 md:mb-12">
          <h2 className="mb-4 text-2xl font-bold md:text-3xl">Governing Law</h2>
          <p className="mb-4 text-black dark:text-white">
        ...
        <section className="mb-8 md:mb-12">
          ...
          <h2 className="mb-4 text-2xl font-bold md:text-xl">Severability</h2>
          <p className="mb-4 text-black dark:text-white">
          ...
          <h2 className="mb-4 text-2xl font-bold md:text-xl">Waiver</h2>
          <p className="mb-4 text-black dark:text-white">
